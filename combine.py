...
def run(
        ...
        source=ROOT / './our_code/data/video.mp4',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / './our_code/data/video.mp4', help='file/dir/URL/glob, 0 for webcam')
